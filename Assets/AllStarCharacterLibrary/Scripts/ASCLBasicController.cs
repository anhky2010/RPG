...
public class ASCLBasicController : MonoBehaviour 
{
	...
	public Enermy[]		enemies;//this array is filled during START by searching for prefabs that have the enemy script attached to them
	...
	{	
		...
		enemies = Transform.FindObjectsOfType(typeof(Enermy))as Enermy[];//find all the instances of the enemy script which are attached to the targets
	}
	...
	void CheckForHit(Enermy en, AbilityCollision ac)
	{
		//AngleRanged
		if(ac.type==0)
		{
